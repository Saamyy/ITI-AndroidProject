...
public class MainActivity extends AppCompatActivity
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Fragment currentFragment2 = getFragmentManager().findFragmentByTag("current_fragment");
            ...
            }else if(currentFragment2 != null && currentFragment2.isVisible() && currentFragment2 instanceof HomeFragment) {
                // super.onBackPressed();
                if(exit)
                {
                    Intent intent = new Intent(Intent.ACTION_MAIN);
